...
const CreateLoadingPreOrders = ({ userID }) => {
  ...
  useEffect(() => {
    ...
    if (preOrderData) {
      ...
      if (preOrderData.addedItems) {
        ...
        console.log("Setting addedItems:", preOrderData.addedItems); // Log addedItems being set
      }
    }
  }, [preOrderData]);
...
export default CreateLoadingPreOrders;
